...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activar para ordenar ascendente la columna",sSortDescending:": activar para ordenar descendente columna"},oPaginate:{sFirst:"<<",sLast:">>",sNext:">",sPrevious:"<"},
sEmptyTable:"No hay datos disponibles en la tabla",sInfo:"Mostrando _START_ de _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 de 0 de 0 registros",sInfoFiltered:"(filtrando de _MAX_ total registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ registros",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No hay registros coincidentes encontrados"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
