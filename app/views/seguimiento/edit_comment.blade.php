    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                {{Field::textarea('comentario',null,null,['class'=>'form-control', 'rows'=>'5', 'id'=>'edit-comentario'])}}
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                <button id="btn-edit-set-comment" type="button" class="btn btn-primary">Guardar</button>
            </div>
        </div>
    </div>
</div>
